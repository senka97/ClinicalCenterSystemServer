...
public interface ClinicRepository  extends JpaRepository<Clinic, Long> {
     ...
     @Query(value = "select me from Clinic c inner join c.medicalExams me where c.id=?1 and me.date>=?2 and me.date<=?3 and me.statusME <> 'REQUESTED'")
     ...
     @Query(value = "select me from Clinic c inner join c.medicalExams me where c.id=?1 and me.date=?2 and me.statusME <> 'REQUESTED'")
