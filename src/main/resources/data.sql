...
insert into medical_record (organ_donor,height,weight,diopter,blood_type) value (true,178,62,0.0,'A+');
...
insert into user (name, surname, email, password, address, city, country, phone_number, serial_number,number_of_reviews, rating, activated_account, enabled, last_password_reset_date, type,medical_record_id) values ('Pera', 'Peric', 'pera@gmail.com','$2a$10$ys.u36Wk7e/9y.dkUb0svOD5I.vaFRtdDwaXQlR5K/O42EYrlWGq6','Alekse Santica 47','Novi Sad','Srbija','0635984156','032163256332',-1,-1,TRUE,TRUE,'2019-11-19 04:00:00','PATIENT',1);
